import type { DOMConversionMap, DOMExportOutput, LexicalEditor, LexicalNode, NodeKey, SerializedElementNode, Spread } from 'lexical';
import { $applyNodeReplacement, ElementNode } from 'lexical';
import type { MdxJsxAttribute } from 'mdast-util-mdx-jsx';
import type { MdxNodeType, htmlTags } from './MdastHTMLNode';
...
/** @internal */
export const typeName = 'generic-html' as const;
