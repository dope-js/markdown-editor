import type { VoidEmitter } from '@/utils';
...
import type { CreateCodeBlockNodeOptions } from './node';
import { $createCodeBlockNode, CodeBlockNode } from './node';
 ...
 * @group Code Block
 */
export const codeBlockPlugin = defineEditorPlugin<{
  /**
